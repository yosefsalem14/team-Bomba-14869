...
public class AUTOT extends Auto {
    ...
    public void runOpMode(){
        ...
        DcMotor[] left = {rover.mainMotors[3],rover.mainMotors[1]};
        //TODO:fix command dir name
        Commands rightFwd = new Commands(right,0.3,Commands.Direction.reverse);
        Commands rightRvrs = new Commands(right,0.3, Commands.Direction.forward);
